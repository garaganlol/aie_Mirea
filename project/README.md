...
- **Название проекта:** `Game Recommendation System (for Steam Users)`
...
- Используется датасет Kaggle: Game Recommendations on Steam (antonkozyriev);
- В репозитории лежит лишь небольшая подвыборка датасетов в `data/`
