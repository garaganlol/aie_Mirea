...
def test_quality_flags_new_logic():
    # DataFrame с константной колонкой, колонкой-ID с дублями и категорией высокой кардинальности
    df = pd.DataFrame(
        {
            "const_col": [1, 1, 1, 1],          # константная колонка
            "user_id": [10, 10, 20, 30],        # дубль ID
            "category": ["A", "B", "C", "D"],   # 4 уникальных значения
        }
    )
