...
### 5. `POST /quality-flags-from-csv` – полный набор флагов качества (вариант A HW04)

Эндпоинт принимает CSV-файл аналогично `/quality-from-csv`, но возвращает **только полный набор флагов качества**, включая эвристики из HW03.
